                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'active'">{{ trans('admin.item.columns.active') }}</th>
                                    <th is='sortable' :column="'type'">{{ trans('admin.item.columns.type') }}</th>
                                    <th is='sortable' :column="'title'">{{ trans('admin.item.columns.title') }}</th>
                                    <th is='sortable' :column="'url'">{{ trans('admin.item.columns.url') }}</th>
